...
dados_armas_rj_consolidado <- dados_armas_formatado |>
  dplyr::mutate(
    ...
    arma_calibre_final = dplyr::if_else(arma_calibre_final == ".32 ou 34 G", ".32", arma_calibre_final),
    arma_calibre_final = toupper(arma_calibre_final),
    arma_calibre_join = dplyr::if_else(stringr::str_detect(arma_calibre_final, "[.](32|22|38) "), stringr::str_sub(arma_calibre_final, 1, 3), arma_calibre_final)
  )
...
# )
#
# flag_arma_policia <- dados_armas_rj_consolidado |>
...
armas_final <- dados_armas_rj_consolidado |>
  dplyr::select(
    id_arma,
...
writexl::write_xlsx(armas_final, "inst/dados_rj/20240904_dados_armas_bruto.xlsx")
